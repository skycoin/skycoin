...
func SKY_wallet_NewWallet(_wltName string, _opts *C.wallet__Options, _arg2 *C.wallet__Wallet) (____error_code uint32) {
	____error_code = 0
	defer func() {
	...
	if ____return_err == nil {
		*_arg2 = *(*C.wallet__Wallet)(unsafe.Pointer(__arg2))
	}
	return
}

//export SKY_wallet_Load
func SKY_wallet_Load(_wltFile string, _arg1 *C.wallet__Wallet) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
	...
	____error_code = libErrorCode(____return_err)
	if ____return_err == nil {
		*_arg1 = *(*C.wallet__Wallet)(unsafe.Pointer(__arg1))
	}
	return
}

//export SKY_wallet_Wallet_Save
func SKY_wallet_Wallet_Save(_w *C.wallet__Wallet, _dir string) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_wallet_Wallet_Validate(_w *C.wallet__Wallet) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_wallet_Wallet_Type(_w *C.wallet__Wallet, _arg0 *C.GoString_) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_wallet_Wallet_Version(_w *C.wallet__Wallet, _arg0 *C.GoString_) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_wallet_Wallet_Filename(_w *C.wallet__Wallet, _arg0 *C.GoString_) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_wallet_Wallet_Label(_w *C.wallet__Wallet, _arg0 *C.GoString_) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_wallet_Wallet_IsEncrypted(_w *C.wallet__Wallet, _arg0 *bool) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_wallet_Wallet_GenerateAddresses(_w *C.wallet__Wallet, _num uint64, _arg1 *C.GoSlice_) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_wallet_Wallet_ScanAddresses(_w *C.wallet__Wallet, _scanN uint64, _bg *C.wallet__BalanceGetter) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_wallet_Wallet_GetAddresses(_w *C.wallet__Wallet, _arg0 *C.GoSlice_) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_wallet_Wallet_GetEntry(_w *C.wallet__Wallet, _a *C.cipher__Address, _arg1 *C.wallet__Entry, _arg2 *bool) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_wallet_Wallet_AddEntry(_w *C.wallet__Wallet, _entry *C.wallet__Entry) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_wallet_Wallet_CreateAndSignTransaction(_w *C.wallet__Wallet, _vld *C.wallet__Validator, _unspent *C.blockdb__UnspentGetter, _headTime, _coins uint64, _dest *C.cipher__Address, _arg4 *C.coin__Transaction) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
