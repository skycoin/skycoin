...
var SkycoinHeaderComponent = (function () {
    ...
    SkycoinHeaderComponent = __decorate([
        core_1.Component({
            ...
            templateUrl: './skycoin-header.component.html',
            styleUrls: ['./skycoin-header.component.css']
        }), 
        __metadata('design:paramtypes', [])
    ], SkycoinHeaderComponent);
    return SkycoinHeaderComponent;
}());
exports.SkycoinHeaderComponent = SkycoinHeaderComponent;
//# sourceMappingURL=skycoin-header.component.js.map