...
func TestWalletChooseSpendsMaximizeUxOutsFailedCase(t *testing.T) {
	uxb := []UxBalance{
		{
			Hash:         cipher.MustSHA256FromHex("47b39a557154494ab91353043cae0f810b20a4a0e52e8a9d3a4a64e740e5664f"),
			Address:      cipher.MustDecodeBase58Address("111111111111111111111691FSP"),
			Coins:        10,
			Hours:        0,
			Time:         0,
			BkSeq:        3,
		...
		{
			Hash:         cipher.MustSHA256FromHex("a1188c7d2b53d9f4f104f312c96b66c655c2ccb5a409f37e6de5956648abaf4d"),
			Address:      cipher.MustDecodeBase58Address("111111111111111111111691FSP"),
			Coins:        9,
			Hours:        2,
			Time:         0,
			BkSeq:        2,
			InitialHours: 0},
		{Hash: cipher.MustSHA256FromHex("c506e0a731eb0ba107e20e2e552a4fba5849bec00b4baf1fc850ea09ffa81c40"),
			Address:      cipher.MustDecodeBase58Address("111111111111111111111691FSP"),
			Coins:        7,
			Hours:        2,
			Time:         0,
			BkSeq:        1,
			InitialHours: 0},
		{Hash: cipher.MustSHA256FromHex("b71e3b1ee6263625981283fceca3b51b4bd2f87ecaa574a1f86ab741856b28ec"),
			Address:      cipher.MustDecodeBase58Address("111111111111111111111691FSP"),
			Coins:        5,
			Hours:        2,
			Time:         0,
			BkSeq:        2,
			InitialHours: 0},
		{Hash: cipher.MustSHA256FromHex("f6d00961e48896b0bb15c150e13f023b9669ff22ea520da0cbacf5d716da2460"),
			Address:      cipher.MustDecodeBase58Address("111111111111111111111691FSP"),
			Coins:        3,
			Hours:        0,
			Time:         0,
			BkSeq:        9,
			InitialHours: 0},
		{Hash: cipher.MustSHA256FromHex("e587786a3809fb5798147be48ef16fea0fcbac33f7034afd78a237ee52cfc2ab"),
			Address:      cipher.MustDecodeBase58Address("111111111111111111111691FSP"),
			Coins:        4,
			Hours:        0,
			Time:         0,
			BkSeq:        4,
			InitialHours: 0},
		{Hash: cipher.MustSHA256FromHex("6845b238948b29f3bc36c25873f2a15e6b9ce03f618b31fa0dd6e71d21a2897e"),
			Address:      cipher.MustDecodeBase58Address("111111111111111111111691FSP"),
			Coins:        2,
			Hours:        2,
			Time:         0,
			BkSeq:        0,
			InitialHours: 0},
		{Hash: cipher.MustSHA256FromHex("eca4e1cf1ba3ebf7d47ac670cbeabd7cac5b4e8e084b69aa11a62b07999e8bff"),
			Address:      cipher.MustDecodeBase58Address("111111111111111111111691FSP"),
			Coins:        5,
			Hours:        1,
			Time:         0,
			BkSeq:        8,
			InitialHours: 0},
		{Hash: cipher.MustSHA256FromHex("4f31973a9d0d2b1ac292b3c36ed3adb8650ca221b58304f8717f1384cf66d262"),
			Address:      cipher.MustDecodeBase58Address("111111111111111111111691FSP"),
			Coins:        5,
			Hours:        0,
			Time:         0,
			BkSeq:        7,
			InitialHours: 0},
		{Hash: cipher.MustSHA256FromHex("b4c7349935e197441a15f832eae206726f92c72765d2f72a39dcbf5e6fa15fe9"),
			Address:      cipher.MustDecodeBase58Address("111111111111111111111691FSP"),
			Coins:        8,
			Hours:        0,
			Time:         0,
			BkSeq:        8,
			InitialHours: 0},
		{Hash: cipher.MustSHA256FromHex("ff022b9cd86ed62efbe9d3bb3b5d4c3abcdbd4269b4091a5d89fa6904e32be84"),
			Address:      cipher.MustDecodeBase58Address("111111111111111111111691FSP"),
			Coins:        2,
			Hours:        2,
			Time:         0,
			BkSeq:        10,
			InitialHours: 0},
		{Hash: cipher.MustSHA256FromHex("80ce1f84adf7a4e7360f07c1b29ceaf0104aa69dc1f8740737793340e9baddca"),
			Address:      cipher.MustDecodeBase58Address("111111111111111111111691FSP"),
			Coins:        5,
			Hours:        1,
			Time:         0,
			BkSeq:        7,
			InitialHours: 0},
		{Hash: cipher.MustSHA256FromHex("0b4505b211f462118e708ba756a9712b187d322da49a283c23ce04debc287148"),
			Address:      cipher.MustDecodeBase58Address("111111111111111111111691FSP"),
			Coins:        6,
			Hours:        2,
			Time:         0,
			BkSeq:        9,
			InitialHours: 0},
		{Hash: cipher.MustSHA256FromHex("0470a7d75a67ca10172917e536ae5926e245f9f9d2e9c504753d2f92916daab7"),
			Address:      cipher.MustDecodeBase58Address("111111111111111111111691FSP"),
			Coins:        5,
			Hours:        1,
			Time:         0,
			BkSeq:        1,
			InitialHours: 0},
		{Hash: cipher.MustSHA256FromHex("e512d33a707ea3fad8421d96d466c48ba4255601c33b0573851dd9a4b7f5a757"),
			Address:      cipher.MustDecodeBase58Address("111111111111111111111691FSP"),
			Coins:        7,
			Hours:        1,
			Time:         0,
			BkSeq:        10,
			InitialHours: 0},
		{Hash: cipher.MustSHA256FromHex("b8b165120c5b4e32b8c86c77969def95b51fd151ffae2b3df8b3309a7b9950b0"),
			Address:      cipher.MustDecodeBase58Address("111111111111111111111691FSP"),
			Coins:        5,
			Hours:        2,
			Time:         0,
			BkSeq:        3,
			InitialHours: 0},
		{Hash: cipher.MustSHA256FromHex("82b58378037d0af31afaa0ce41c75e5797e84bf0e433d1bb502cb82453f70107"),
			Address:      cipher.MustDecodeBase58Address("111111111111111111111691FSP"),
			Coins:        2,
			Hours:        2,
			Time:         0,
			BkSeq:        9,
			InitialHours: 0},
		{Hash: cipher.MustSHA256FromHex("c7220e8d10d365776402e2ca7c2e46ed0d196722911e246167f655f40e4ec653"),
			Address:      cipher.MustDecodeBase58Address("111111111111111111111691FSP"),
			Coins:        2,
			Hours:        1,
			Time:         0,
			BkSeq:        7,
			InitialHours: 0},
		{Hash: cipher.MustSHA256FromHex("c96e22f2da26fe736b8a645ad9576845383584a60416d606cb60e3b219bac30b"),
			Address:      cipher.MustDecodeBase58Address("111111111111111111111691FSP"),
			Coins:        4,
			Hours:        2,
			Time:         0,
