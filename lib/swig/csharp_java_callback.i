...
// %typemap(cscode) FeeCalculator* %{
//   public  delegate  context = (SWIGTYPE_p_Transaction__Handle, SWIGTYPE_p_unsigned_long_long , SWIGTYPE_p_FeeCalcFunc); 
// %}
...
%cs_callback2(FeeCalcFunc*,FeeCalcFunc*,FeeCalculator)