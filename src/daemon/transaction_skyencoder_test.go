...
func testSkyencoderTransaction(t *testing.T, obj *coin.Transaction) {
...
func testSkyencoderTransactionDecodeErrors(t *testing.T, k int, tag string, obj *coin.Transaction) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
