...
func SKY_visor_NewTransactionResult(_tx *C.Transaction, _arg1 *C.TransactionResult) (____error_code uint32) {
	____error_code = 0
	defer func() {
...
func SKY_visor_NewTransactionResults(_txs *C.GoSlice_, _arg1 *C.TransactionResults) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_visor_MakeRPC(_v *C.Visor, _arg1 *C.RPC) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_visor_RPC_GetBlockchainMetadata(_rpc *C.RPC, _v *C.Visor, _arg1 *C.BlockchainMetadata) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_visor_RPC_GetUnspent(_rpc *C.RPC, _v *C.Visor, _arg1 *C.UnspentPool) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_visor_RPC_GetUnconfirmedSpends(_rpc *C.RPC, _v *C.Visor, _addrs *C.GoSlice_, _arg2 *C.AddressUxOuts) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_visor_RPC_GetUnconfirmedReceiving(_rpc *C.RPC, _v *C.Visor, _addrs *C.GoSlice_, _arg2 *C.AddressUxOuts) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_visor_RPC_GetUnconfirmedTxns(_rpc *C.RPC, _v *C.Visor, _addresses *C.GoSlice_, _arg2 *C.GoSlice_) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_visor_RPC_GetBlock(_rpc *C.RPC, _v *C.Visor, _seq uint64, _arg2 *C.SignedBlock) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_visor_RPC_GetBlocks(_rpc *C.RPC, _v *C.Visor, _start, _end uint64, _arg2 *C.GoSlice_) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_visor_RPC_GetLastBlocks(_rpc *C.RPC, _v *C.Visor, _num uint64, _arg2 *C.GoSlice_) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_visor_RPC_GetBlockBySeq(_rpc *C.RPC, _v *C.Visor, _n uint64, _arg2 *C.SignedBlock) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_visor_RPC_GetTransaction(_rpc *C.RPC, _v *C.Visor, _txHash *C.SHA256, _arg2 *C.Transaction) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_visor_RPC_GetAddressTxns(_rpc *C.RPC, _v *C.Visor, _addr *C.Address, _arg2 *C.GoSlice_) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_visor_RPC_CreateWallet(_rpc *C.RPC, _wltName string, _options *C.Options, _arg2 *C.Wallet) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_visor_RPC_NewAddresses(_rpc *C.RPC, _wltName string, _num uint64, _arg2 *C.GoSlice_) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_visor_RPC_GetWalletAddresses(_rpc *C.RPC, _wltID string, _arg1 *C.GoSlice_) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_visor_RPC_CreateAndSignTransaction(_rpc *C.RPC, _wltID string, _password *C.GoSlice_, _vld *C.Validator, _unspent *C.UnspentGetter, _headTime, _coins uint64, _dest *C.Address, _arg6 *C.Transaction) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_visor_RPC_UpdateWalletLabel(_rpc *C.RPC, _wltID, _label string) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_visor_RPC_GetWallet(_rpc *C.RPC, _wltID string, _arg1 *C.Wallet) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_visor_RPC_GetWallets(_rpc *C.RPC, _arg0 *C.Wallets) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_visor_RPC_ReloadWallets(_rpc *C.RPC) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_visor_RPC_GetBuildInfo(_rpc *C.RPC, _arg0 *C.BuildInfo) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
...
func SKY_visor_RPC_UnloadWallet(_rpc *C.RPC, _id string) (____error_code uint32) {
	____error_code = 0
	defer func() {
		____error_code = catchApiPanic(____error_code, recover())
	}()
