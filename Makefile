...
.PHONY: install-swagger run-swagger validate-swagger
...
validate-swagger: ## Validate the specification generated by go-swagger against swagger 2.0 specification
