...
func (w *XPubWallet) Lock(password []byte) error {
	panic("implement me")
}

func (w *XPubWallet) Unlock(password []byte) (Wallet, error) {
	panic("implement me")
}

func (w *XPubWallet) GenerateAddresses(num uint64) ([]cipher.Address, error) {
	panic("implement me")
}

func (w *XPubWallet) ScanAddresses(scanN uint64, tf TransactionsFinder) ([]cipher.Address, error) {
	panic("implement me")
}

func (w *XPubWallet) Serialize() ([]byte, error) {
	panic("implement me")
}

func (w *XPubWallet) Deserialize(data []byte) error {
	panic("implement me")
}
...
func (w *XPubWallet) Clone() *XPubWallet {
...
func (w *XPubWallet) GetEntries() (entry.Entries, error) {
...
func (w *XPubWallet) ScanAddresses(scanN uint64, tf TransactionsFinder) ([]cipher.Addresser, error) {
	//if w.Meta.IsEncrypted() {
