...
type DeterministicWalletSeed coin.SHA256
...
func (self *DeterministicWallet) GetAddresses() []coin.Address {
    return []coin.Address{self.Entry.Address}
}

func (self *DeterministicWallet) GetEntry(a coin.Address) (WalletEntry, bool) {
