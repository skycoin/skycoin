...
func (_m *MockBlockchainer) VerifySingleTxnHardConstraints(tx *dbutil.Tx, txn coin.Transaction, signed transaction.TxnSignedFlag) error {
	ret := _m.Called(tx, txn, signed)

	var r0 error
	if rf, ok := ret.Get(0).(func(*dbutil.Tx, coin.Transaction, transaction.TxnSignedFlag) error); ok {
		r0 = rf(tx, txn, signed)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *MockBlockchainer) VerifySingleTxnSoftHardConstraints(tx *dbutil.Tx, txn coin.Transaction, distParams params.Distribution, verifyParams params.VerifyTxn, signed transaction.TxnSignedFlag) (*coin.SignedBlock, coin.UxArray, error) {
	ret := _m.Called(tx, txn, distParams, verifyParams, signed)

	var r0 *coin.SignedBlock
	if rf, ok := ret.Get(0).(func(*dbutil.Tx, coin.Transaction, params.Distribution, params.VerifyTxn, transaction.TxnSignedFlag) *coin.SignedBlock); ok {
	...
	var r1 coin.UxArray
	if rf, ok := ret.Get(1).(func(*dbutil.Tx, coin.Transaction, params.Distribution, params.VerifyTxn, transaction.TxnSignedFlag) coin.UxArray); ok {
	...
	var r2 error
	if rf, ok := ret.Get(2).(func(*dbutil.Tx, coin.Transaction, params.Distribution, params.VerifyTxn, transaction.TxnSignedFlag) error); ok {
