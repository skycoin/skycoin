...
func (txus *txUnspents) get(tx *dbutil.Tx, hash cipher.SHA256) (coin.UxArray, error) { // nolint: unused
...
func (txus *txUnspents) length(tx *dbutil.Tx) (uint64, error) { // nolint: unused
...
func (txus *txUnspents) forEach(tx *dbutil.Tx, f func(cipher.SHA256, coin.UxArray) error) error { // nolint: unused
