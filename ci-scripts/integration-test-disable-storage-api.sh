...
MODE="disable-storage-api"
BINARY="${COIN}-integration-disable-storage-api.test"
UPDATE=""
...
SKYCOIN_INTEGRATION_TESTS=1 SKYCOIN_INTEGRATION_TEST_MODE=$MODE SKYCOIN_NODE_HOST=$HOST STORAGE_DIR=$STORAGE_DIR \
