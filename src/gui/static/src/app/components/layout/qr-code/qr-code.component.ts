...
import { copyTextToClipboard, removeCommas, toBigNumber } from '../../../utils/general-utils';
...
export class QrCodeComponent implements OnInit, OnDestroy {
  ...
  private updateQrContent() {
    ...
    if (this.form.get('coins')!.value) {
      const coins = toBigNumber(removeCommas(this.form.get('coins')!.value));
    ...
    if (this.form.get('hours')!.value) {
      const hours = toBigNumber(removeCommas(this.form.get('hours')!.value));
