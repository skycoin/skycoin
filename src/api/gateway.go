...
type Visorer interface {
	...
	GetTransactions(flts []visor.TxFilter, page *visor.PageIndex) ([]visor.Transaction, uint64, error)
	GetTransactionsWithInputs(flts []visor.TxFilter, page *visor.PageIndex) ([]visor.Transaction, [][]visor.TransactionInput, uint64, error)
