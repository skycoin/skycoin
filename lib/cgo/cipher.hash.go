...
func SKY_cipher_HashRipemd160(_data []byte, _arg1 *C.cipher__Ripemd160) {
...
func SKY_cipher_SHA256_Hex(_g *C.cipher__SHA256, _arg1 *C.GoString_) {
	g := (*cipher.SHA256)(unsafe.Pointer(_g))
	copyString(g.Hex(), _arg1)
}

//export SKY_cipher_SHA256_Xor
func SKY_cipher_SHA256_Xor(_g *C.cipher__SHA256, _b *C.cipher__SHA256, _arg1 *C.cipher__SHA256) {
	g := (*cipher.SHA256)(unsafe.Pointer(_g))
...
func SKY_cipher_Merkle(_h0 *[]C.cipher__SHA256, _arg1 *C.cipher__SHA256) {
