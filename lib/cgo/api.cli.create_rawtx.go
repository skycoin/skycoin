...
func SKY_cli_CreateRawTxFromWallet(_ctx C.Handle, _walletFile, _chgAddr string, _toAddrs []C.SendAmount, _tx *C.Transaction) C.uint32 {
...
func SKY_cli_CreateRawTxFromAddress(_ctx C.Handle, _addr, _walletFile, _chgAddr string, _toAddrs []C.SendAmount, _tx *C.Transaction) C.uint32 {
	// TODO: Implement
	return 0
}
