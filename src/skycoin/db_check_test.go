...
func TestCheckDB(t *testing.T) {
	...
	tt := []struct {
		...
		},
		{
			...
			params: dbCheckConfig{DBVersion: v25, AppVersion: v241, DBCheckpointVersion: v25},
		...
		},
		{
			...
			params: dbCheckConfig{DBVersion: v241, AppVersion: v26, DBCheckpointVersion: v25},
			exp:    expect{action: doCheckDB},
		},
		{
			name:   "db version < check point < app version, reset corrupt db",
			params: dbCheckConfig{DBVersion: v241, AppVersion: v26, ResetCorruptDB: true, DBCheckpointVersion: v25},
			exp:    expect{action: doResetCorruptDB},
		},
		{
			name:   "db version < check point == app version, check DB",
			params: dbCheckConfig{DBVersion: v241, AppVersion: &dbVerifyCheckpointVersionParsed, DBCheckpointVersion: v25},
			exp:    expect{action: doCheckDB},
		},
		{
			name:   "db version < check point == app version, reset corrupt DB",
			params: dbCheckConfig{DBVersion: v241, AppVersion: &dbVerifyCheckpointVersionParsed, ResetCorruptDB: true, DBCheckpointVersion: v25},
			exp:    expect{action: doResetCorruptDB},
		},
		{
			name:   "db version == app version, force verify, check DB",
			params: dbCheckConfig{DBVersion: v26, AppVersion: v26, ForceVerify: true, DBCheckpointVersion: v25},
			exp:    expect{action: doCheckDB},
		},
		{
			name:   "db version == app version, force verify, reset corrupt DB",
			params: dbCheckConfig{DBVersion: v26, AppVersion: v26, ForceVerify: true, ResetCorruptDB: true, DBCheckpointVersion: v25},
			exp:    expect{action: doResetCorruptDB},
		},
	}
