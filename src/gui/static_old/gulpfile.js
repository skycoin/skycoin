...
var paths = {
    ...
    partials: ['app/**/*.jade', '!app/index.html'],
    distDev: 'dist',
    distProd: 'dist.prod',
...
pipes.orderedVendorScripts = function() {
    return plugins.order(['jquery.js', 'angular.js', 'qrcode', 'angular-qrcode']);
};
...
pipes.builtVendorScriptsDev = function() {
    return gulp.src(bowerFiles())
        .pipe(plugins.if(
          '*.css',
          gulp.dest(paths.distDev + '/libs/css')
        ))
        .pipe(plugins.if(
          /.*\.eot|svg|ttf|woff|woff2/,
          gulp.dest(paths.distDev + '/libs/fonts')
        ))
        .pipe(plugins.if(
          /.*\.png|git|jpg|jpeg|/,
          gulp.dest(paths.distDev + '/libs/img')
        ))
        .pipe(pipes.orderedVendorScripts())
        .pipe(gulp.dest(paths.distDev + '/libs/js'));
};
