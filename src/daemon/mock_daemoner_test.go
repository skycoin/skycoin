...
func (_m *mockDaemoner) injectTransaction(txn coin.Transaction) (bool, *transaction.ErrTxnViolatesSoftConstraint, error) {
	ret := _m.Called(txn)
	...
	if rf, ok := ret.Get(1).(func(coin.Transaction) *transaction.ErrTxnViolatesSoftConstraint); ok {
		r1 = rf(txn)
	} else {
		if ret.Get(1) != nil {
