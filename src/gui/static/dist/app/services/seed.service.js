System.register(['@angular/core', '@angular/http', 'rxjs/Observable', 'rxjs/add/operator/map', 'rxjs/add/operator/catch'], function(exports_1, context_1) {
    ...
    return {
        setters:[
            ...
            function (_2) {}],
        execute: function() {
            SeedService = (function () {
                function SeedService(_http) {
                    this._http = _http;
                }
                SeedService.prototype.getMnemonicSeed = function () {
                    return this._http
                        .get('/wallet/newSeed', { headers: this.getHeaders() })
                        .map(function (res) { return res.json(); })
                        .catch(function (error) { return Observable_1.Observable.throw(error.json().error || 'Server error'); });
                };
                SeedService.prototype.getHeaders = function () {
            ...
            exports_1("SeedService", SeedService);
        }
    }
});
