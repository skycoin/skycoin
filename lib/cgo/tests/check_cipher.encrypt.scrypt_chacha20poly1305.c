...
Test(cipher_encrypt_scrypt_chacha20poly1305, TestScryptChacha20poly1305Encrypt)
{
  ...
  for (int i = 1; i <= 20; i++)
  {
    ...
    errcode = SKY_encrypt_ScryptChacha20poly1305_Encrypt(
      &encrypt, text, password, (GoSlice_ *)&result);
...
Test(cipher_encrypt_scrypt_chacha20poly1305, TestScryptChacha20poly1305Decrypt)
{
  ...
  errcode = SKY_encrypt_ScryptChacha20poly1305_Decrypt(&encrypt, encrypted, password2, (GoSlice_ *)&result);
  ...
  errcode = SKY_encrypt_ScryptChacha20poly1305_Decrypt(&encrypt, encrypted, wrong_password, (GoSlice_ *)&result);
  cr_assert(errcode == SKY_ERROR, "SKY_encrypt_ScryptChacha20poly1305_Decrypt decrypted with wrong password.");
  result.cap = result.len = 0;
  errcode = SKY_encrypt_ScryptChacha20poly1305_Decrypt(&encrypt, encrypted, nullPassword, (GoSlice_ *)&result);
