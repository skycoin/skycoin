...
type Visorer interface {
	...
	GetTransactions(flts []visor.TxFilter, page *historydb.PageIndex) ([]visor.Transaction, uint64, error)
	GetTransactionsWithInputs(flts []visor.TxFilter, page *historydb.PageIndex) ([]visor.Transaction, [][]visor.TransactionInput, uint64, error)
