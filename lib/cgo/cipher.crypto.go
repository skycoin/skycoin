...
func SKY_cipher_PubKeySlice_Len(_slice *C.cipher_PubKeySlice) int {
	slice := inplacePubKeySlice(_slice)
	return slice.Len()
}

//export SKY_cipher_PubKeySlice_Less
func SKY_cipher_PubKeySlice_Less(_slice *C.cipher_PubKeySlice, _i, _j int) bool {
	slice := inplacePubKeySlice(_slice)
	return slice.Less(_i, _j)
}

//export SKY_cipher_PubKeySlice_Swap
func SKY_cipher_PubKeySlice_Swap(_slice *C.cipher_PubKeySlice, _i, _j int) {
	slice := inplacePubKeySlice(_slice)
	slice.Swap(_i, _j)
}
...
func SKY_cipher_NewPubKey(_b []byte, _arg1 *C.cipher_PubKey) (errcode uint32) {
	defer func() {
...
func SKY_cipher_PubKeyFromHex(_s string, _arg1 *C.cipher_PubKey) (errcode uint32) {
	defer func() {
		errcode = catchApiPanic(errcode, recover())
	}()
...
func SKY_cipher_PubKeyFromSecKey(_seckey *C.cipher_SecKey, _arg1 *C.cipher_PubKey) (errcode uint32) {
	defer func() {
		errcode = catchApiPanic(errcode, recover())
	}()
...
func SKY_cipher_PubKeyFromSig(_sig *C.cipher_Sig, _hash *C.cipher_SHA256, _arg2 *C.cipher_PubKey) uint32 {
...
func SKY_cipher_PubKey_Verify(_pk *C.cipher_PubKey) uint32 {
...
func SKY_cipher_PubKey_Hex(_pk *C.cipher_PubKey, _arg1 *C.GoString_) {
	pk := (*cipher.PubKey)(unsafe.Pointer(_pk))
	s := pk.Hex()
	copyString(s, _arg1)
}
...
func SKY_cipher_PubKey_ToAddressHash(_pk *C.cipher_PubKey, _arg0 *C.cipher_Ripemd160) {
	pk := (*cipher.PubKey)(unsafe.Pointer(_pk))
	h := pk.ToAddressHash()
...
func SKY_cipher_NewSecKey(_b []byte, _arg1 *C.cipher_SecKey) (errcode uint32) {
	defer func() {
		errcode = catchApiPanic(errcode, recover())
	}()
...
func SKY_cipher_SecKeyFromHex(_s string, _arg1 *C.cipher_SecKey) uint32 {
...
func SKY_cipher_SecKey_Verify(_sk *C.cipher_SecKey) uint32 {
...
func SKY_cipher_SecKey_Hex(_sk *C.cipher_SecKey, _arg1 *C.GoString_) {
	sk := (*cipher.SecKey)(unsafe.Pointer(_sk))
	s := sk.Hex()
	copyString(s, _arg1)
}
...
func SKY_cipher_ECDH(_pub *C.cipher_PubKey, _sec *C.cipher_SecKey, _arg2 *C.GoSlice_) {
...
func SKY_cipher_NewSig(_b []byte, _arg1 *C.cipher_Sig) (errcode uint32) {
	defer func() {
		errcode = catchApiPanic(errcode, recover())
	}()
...
func SKY_cipher_SigFromHex(_s string, _arg1 *C.cipher_Sig) uint32 {
...
func SKY_cipher_Sig_Hex(_s *C.cipher_Sig, _arg1 *C.GoString_) {
	s := (*cipher.Sig)(unsafe.Pointer(_s))
	copyString(s.Hex(), _arg1)
}

//export SKY_cipher_SignHash
func SKY_cipher_SignHash(_hash *C.cipher_SHA256, _sec *C.cipher_SecKey, _arg2 *C.cipher_Sig) {
	hash := (*cipher.SHA256)(unsafe.Pointer(_hash))
	sec := (*cipher.SecKey)(unsafe.Pointer(_sec))
...
func SKY_cipher_ChkSig(_address *C.cipher_Address, _hash *C.cipher_SHA256, _sig *C.cipher_Sig) uint32 {
...
func SKY_cipher_VerifySignedHash(_sig *C.cipher_Sig, _hash *C.cipher_SHA256) uint32 {
	hash := (*cipher.SHA256)(unsafe.Pointer(_hash))
	sig := (*cipher.Sig)(unsafe.Pointer(_sig))
...
func SKY_cipher_VerifySignature(_pubkey *C.cipher_PubKey, _sig *C.cipher_Sig, _hash *C.cipher_SHA256) uint32 {
...
func SKY_cipher_GenerateKeyPair(_arg0 *C.cipher_PubKey, _arg1 *C.cipher_SecKey) {
...
func SKY_cipher_GenerateDeterministicKeyPair(_seed []byte, _arg1 *C.cipher_PubKey, _arg2 *C.cipher_SecKey) {
...
func SKY_cipher_DeterministicKeyPairIterator(_seed []byte, _arg1 *C.GoSlice_, _arg2 *C.cipher_PubKey, _arg3 *C.cipher_SecKey) {
...
func SKY_cipher_TestSecKey(_seckey *C.cipher_SecKey) uint32 {
	seckey := (*cipher.SecKey)(unsafe.Pointer(_seckey))
...
func SKY_cipher_TestSecKeyHash(_seckey *C.cipher_SecKey, _hash *C.cipher_SHA256) uint32 {
	seckey := (*cipher.SecKey)(unsafe.Pointer(_seckey))
	hash := (*cipher.SHA256)(unsafe.Pointer(_hash))
