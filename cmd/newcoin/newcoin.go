...
func createCoinCommand() cli.Command {
	...
	return cli.Command{
		...
		Action: func(c *cli.Context) error {
			...
			config, err := skycoin.NewConfig(configFile, configDir)
			if err != nil {
			...
			err = t.ExecuteTemplate(visorParamsFile, visorTemplateFile, config.VisorParameters)
			if err != nil {
