...
.PHONY: install-swagger run-swagger check-swagger
...
run-swagger: ## Generate swagger 2.0 specification for Skycoin Api
	@swagger generate spec -b github.com/skycoin/skycoin/src/api -o ./swagger.yml
	@swagger generate spec -b github.com/skycoin/skycoin/src/api -o ./swagger.json

check-swagger: run-swagger ## Validate the specification generated by go-swagger against swagger 2.0 specification
...
check: lint clean-coverage test integration-test-stable integration-test-stable-disable-csrf \
	...
	integration-test-auth integration-test-db-no-unconfirmed check-newcoin check-swagger ## Run tests and linters
