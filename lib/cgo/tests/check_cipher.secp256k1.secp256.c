...
Test(cipher_secp256k1, Test_SignatureVerifyPubkey)
{
  ...
  error_code = SKY_secp256k1_GenerateKeyPair((GoSlice_ *)&pubKeySlice, (GoSlice_ *)&secKeySlice);
  cr_assert(error_code == SKY_OK, "SKY_secp256k1_GenerateKeyPair failed");

  GoSlice msg = {buff, 0, SigSize};
  SKY_secp256k1_RandByte(32, (GoSlice_ *)&msg);
  ...
  SKY_secp256k1_RecoverPubkey(msg, sig, (GoSlice_ *)&recoveredPubKeySlice);
...
Test(cipher_secp256k1, Test_Secp256_02)
{
  ...
  error_code = SKY_secp256k1_RecoverPubkey(msg, sig, (GoSlice_ *)&pub2);
  cr_assert(error_code == SKY_OK, "SKY_secp256k1_RecoverPubkey failed");
...
Test(cipher_secp256k1, Test_Deterministic_Keypairs_00)
{
  ...
  for (int i = 0; i < 64; i++)
  {
    error_code = SKY_secp256k1_RandByte(32, (GoSlice_ *)&seed);
    cr_assert(error_code == SKY_OK, "SKY_secp256k1_RandByte failed");
...
Test(cipher_secp256k1, Test_Deterministic_Keypairs_03)
{
  ...
  const char *testArray[] = {
    "tQ93w5Aqcunm9SGUfnmF4fJv",
    "9b8c3e36adce64dedc80d6dfe51ff1742cc1d755bbad457ac01177c5a18a789f",
    "DC7qdQQtbWSSaekXnFmvQgse",
    "d2deaf4a9ff7a5111fe1d429d6976cbde78811fdd075371a2a4449bb0f4d8bf9",
    "X8EkuUZC7Td7PAXeS7Duc7vR",
    "cad79b6dcf7bd21891cbe20a51c57d59689ae6e3dc482cd6ec22898ac00cd86b",
    "tVqPYHHNVPRWyEed62v7f23u",
    "2a386e94e9ffaa409517cbed81b9b2d4e1c5fb4afe3cbd67ce8aba11af0b02fa",
    "kCy4R57HDfLqF3pVhBWxuMcg",
    "26a7c6d8809c476a56f7455209f58b5ff3f16435fcf208ff2931ece60067f305",
    "j8bjv86ZNjKqzafR6mtSUVCE",
    "ea5c0f8c9f091a70bf38327adb9b2428a9293e7a7a75119920d759ecfa03a995",
    "qShryAzVY8EtsuD3dsAc7qnG",
    "331206176509bcae31c881dc51e90a4e82ec33cd7208a5fb4171ed56602017fa",
    "5FGG7ZBa8wVMBJkmzpXj5ESX",
    "4ea2ad82e7730d30c0c21d01a328485a0cf5543e095139ba613929be7739b52c",
    "f46TZG4xJHXUGWx8ekbNqa9F",
    "dcddd403d3534c4ef5703cc07a771c107ed49b7e0643c6a2985a96149db26108",
    "XkZdQJ5LT96wshN8JBH8rvEt",
    "3e276219081f072dff5400ca29a9346421eaaf3c419ff1474ac1c81ad8a9d6e1",
    "GFDqXU4zYymhJJ9UGqRgS8ty",
    "95be4163085b571e725edeffa83fff8e7a7db3c1ccab19d0f3c6e105859b5e10",
    "tmwZksH2XyvuamnddYxyJ5Lp",
    "2666dd54e469df56c02e82dffb4d3ea067daafe72c54dc2b4f08c4fb3a7b7e42",
    "EuqZFsbAV5amTzkhgAMgjr7W",
    "40c325c01f2e4087fcc97fcdbea6c35c88a12259ebf1bce0b14a4d77f075abbf",
    "TW6j8rMffZfmhyDEt2JUCrLB",
    "e676e0685c5d1afd43ad823b83db5c6100135c35485146276ee0b0004bd6689e",
    "8rvkBnygfhWP8kjX9aXq68CY",
    "21450a646eed0d4aa50a1736e6c9bf99fff006a470aab813a2eff3ee4d460ae4",
    "phyRfPDuf9JMRFaWdGh7NXPX",
    "ca7bc04196c504d0e815e125f7f1e086c8ae8c10d5e9df984aeab4b41bf9e398",
  };
...
Test(cipher_secp256k1, Test_DeterministicWallets1)
{
  int test_count = 16;
  const char *testArray[] = {
    "90c56f5b8d78a46fb4cddf6fd9c6d88d6d2d7b0ec35917c7dac12c03b04e444e",
    "94dd1a9de9ffd57b5516b8a7f090da67f142f7d22356fa5d1b894ee4d4fba95b",
    "a3b08ccf8cbae4955c02f223be1f97d2bb41d92b7f0c516eb8467a17da1e6057",
    "82fba4cc2bc29eef122f116f45d01d82ff488d7ee713f8a95c162a64097239e0",
    ...
    "d709ceb1a6fb906de506ea091c844ca37c65e52778b8d257d1dd3a942ab367fb",
    "7214b4c09f584c5ddff971d469df130b9a3c03e0277e92be159279de39462120",
    ...
    "9403bff4240a5999e17e0ab4a645d6942c3a7147c7834e092e461a4580249e6e",
    "d495174b8d3f875226b9b939121ec53f9383bd560d34aa5ca3ac6b257512adf4",
    "2665312a3e3628f4df0b9bc6334f530608a9bcdd4d1eef174ecda99f51a6db94",
    ...
    "c87c85a6f482964db7f8c31720981925b1e357a9fdfcc585bc2164fdef1f54d0",
    "8654a32fa120bfdb7ca02c487469070eba4b5a81b03763a2185fdf5afd756f3c",
    "e2767d788d1c5620f3ef21d57f2d64559ab203c044f0a5f0730b21984e77019c",
    ...
    "479ec3b589b14aa7290b48c2e64072e4e5b15ce395d2072a5a18b0a2cf35f3fd",
    "f10e2b7675dfa557d9e3188469f12d3e953c2d46dce006cd177b6ae7f465cfc0",
    "63952334b731ec91d88c54614925576f82e3610d009657368fc866e7b1efbe73",
    "0bcbebb39d8fe1cb3eab952c6f701656c234e462b945e2f7d4be2c80b8f2d974",
    "256472ee754ef6af096340ab1e161f58e85fb0cc7ae6e6866b9359a1657fa6c1",
    "88ba6f6c66fc0ef01c938569c2dd1f05475cb56444f4582d06828e77d54ffbe6",
  };
  GoInt32 error_code;
  char bufferSeed[BUFFER_SIZE];
  char bufferSec1[BUFFER_SIZE];
...
Test(cipher_secp256k1, Test_Secp256k1_Hash)
{
  ...
  const char *testArray[] = {
    "90c56f5b8d78a46fb4cddf6fd9c6d88d6d2d7b0ec35917c7dac12c03b04e444e",
    "a70c36286be722d8111e69e910ce4490005bbf9135b0ce8e7a59f84eee24b88b",
    "a3b08ccf8cbae4955c02f223be1f97d2bb41d92b7f0c516eb8467a17da1e6057",
    "e9db072fe5817325504174253a056be7b53b512f1e588f576f1f5a82cdcad302",
    "7048eb8fa93cec992b93dc8e93c5543be34aad05239d4c036cf9e587bbcf7654",
    "5e9133e83c4add2b0420d485e1dcda5c00e283c6509388ab8ceb583b0485c13b",
    "6d25375591bbfce7f601fc5eb40e4f3dde2e453dc4bf31595d8ec29e4370cd80",
    "8d5579cd702c06c40fb98e1d55121ea0d29f3a6c42f5582b902ac243f29b571a",
    "7214b4c09f584c5ddff971d469df130b9a3c03e0277e92be159279de39462120",
    "3a4e8c72921099a0e6a4e7f979df4c8bced63063097835cdfd5ee94548c9c41a",
    "b13e78392d5446ae304b5fc9d45b85f26996982b2c0c86138afdac8d2ea9016e",
    "462efa1bf4f639ffaedb170d6fb8ba363efcb1bdf0c5aef0c75afb59806b8053",
    "9403bff4240a5999e17e0ab4a645d6942c3a7147c7834e092e461a4580249e6e",
    "68dd702ea7c7352632876e9dc2333142fce857a542726e402bb480cad364f260",
    "2665312a3e3628f4df0b9bc6334f530608a9bcdd4d1eef174ecda99f51a6db94",
    "5db72c31d575c332e60f890c7e68d59bd3d0ac53a832e06e821d819476e1f010",
    "6cb37532c80765b7c07698502a49d69351036f57a45a5143e33c57c236d841ca",
    "0deb20ec503b4c678213979fd98018c56f24e9c1ec99af3cd84b43c161a9bb5c",
    "8654a32fa120bfdb7ca02c487469070eba4b5a81b03763a2185fdf5afd756f3c",
    "36f3ede761aa683813013ffa84e3738b870ce7605e0a958ed4ffb540cd3ea504",
    "66d1945ceb6ef8014b1b6703cb624f058913e722f15d03225be27cb9d8aabe4a",
    "6bcb4819a96508efa7e32ee52b0227ccf5fbe5539687aae931677b24f6d0bbbd",
    "22c7623bf0e850538329e3e6d9a6f9b1235350824a3feaad2580b7a853550deb",
    "8bb257a1a17fd2233935b33441d216551d5ff1553d02e4013e03f14962615c16",
    "a5eebe3469d68c8922a1a8b5a0a2b55293b7ff424240c16feb9f51727f734516",
    "d6b780983a63a3e4bcf643ee68b686421079c835a99eeba6962fe41bb355f8da",
    "479ec3b589b14aa7290b48c2e64072e4e5b15ce395d2072a5a18b0a2cf35f3fd",
    "39c5f108e7017e085fe90acfd719420740e57768ac14c94cb020d87e36d06752",
    "63952334b731ec91d88c54614925576f82e3610d009657368fc866e7b1efbe73",
...
Test(cipher_secp256k1, Test_Secp256k1_Equal)
{
  ...
  for (int i = 0; i < 64; i++)
  {
    error_code = SKY_secp256k1_RandByte(128, (GoSlice_ *)&seed);
    cr_assert(error_code == SKY_OK, "SKY_secp256k1_RandByte failed");
    error_code = SKY_secp256k1_Secp256k1Hash(seed, (GoSlice_ *)&hash1);
    cr_assert(error_code == SKY_OK, "SKY_secp256k1_Secp256k1Hash failed");
    error_code = SKY_secp256k1_DeterministicKeyPairIterator(seed,
                                (GoSlice_ *)&hash2,
                                (GoSlice_ *)&public,
...
Test(cipher_secp256k1, Test_ECDH)
{
  ...
  error_code = SKY_secp256k1_GenerateKeyPair(
    (GoSlice_ *)&pubKeySlice1, (GoSlice_ *)&secKeySlice1);
  cr_assert(error_code == SKY_OK, "SKY_secp256k1_GenerateKeyPair failed");
  error_code = SKY_secp256k1_GenerateKeyPair(
    (GoSlice_ *)&pubKeySlice2, (GoSlice_ *)&secKeySlice2);
  cr_assert(error_code == SKY_OK, "SKY_secp256k1_GenerateKeyPair failed");

  SKY_secp256k1_ECDH(pubKeySlice1, secKeySlice2, (GoSlice_ *)&ecdh1);
  cr_assert(error_code == SKY_OK, "SKY_secp256k1_ECDH failed.");
  SKY_secp256k1_ECDH(pubKeySlice2, secKeySlice1, (GoSlice_ *)&ecdh2);
  cr_assert(error_code == SKY_OK, "SKY_secp256k1_ECDH failed.");
...
Test(cipher_secp256k1, Test_Abnormal_Keys)
{
  ...
  for (int i = 0; i < 32; i++)
  {
    ...
    cr_assert(error_code == SKY_OK, "SKY_secp256k1_RandByte failed.");
    error_code = SKY_secp256k1_GenerateDeterministicKeyPair(seed,
                                (GoSlice_ *)&privatekey, (GoSlice_ *)&pubKey);
    cr_assert(error_code == SKY_OK, "SKY_secp256k1_GenerateDeterministicKeyPair failed.");
    GoInt verified = 0;
...
Test(cipher_secp256k1, Test_Abnormal_Keys2)
{
  ...
  for (int i = 0; i < keys_count; i++)
  {
    ...
    error_code = SKY_secp256k1_PubkeyFromSeckey(privatekey, (GoSlice_ *)&pubKey);
...
Test(cipher_secp256k1, Test_Abnormal_Keys3)
{
  ...
  for (int i = 0; i < keys_count; i++)
  {
    ...
    error_code = SKY_secp256k1_PubkeyFromSeckey(privatekey1, (GoSlice_ *)&pubKey1);
    cr_assert(error_code == SKY_OK, "SKY_secp256k1_PubkeyFromSeckey failed.");
    cr_assert(pubKey1.len > 0, "SKY_secp256k1_PubkeyFromSeckey failed.");
    error_code = SKY_secp256k1_PubkeyFromSeckey(privatekey2, (GoSlice_ *)&pubKey2);
    cr_assert(error_code == SKY_OK, "SKY_secp256k1_PubkeyFromSeckey failed.");
    cr_assert(pubKey2.len > 0, "SKY_secp256k1_PubkeyFromSeckey failed.");

    SKY_secp256k1_ECDH(pubKey1, privatekey2, (GoSlice_ *)&ecdh1);
    cr_assert(error_code == SKY_OK, "SKY_secp256k1_ECDH failed.");
    SKY_secp256k1_ECDH(pubKey2, privatekey1, (GoSlice_ *)&ecdh2);
    cr_assert(error_code == SKY_OK, "SKY_secp256k1_ECDH failed.");
