...
cr_assert(eq(type(char),rp1,rp2));
...
Test(hash,TestSHA256KnownValue){
	...
	vals[0].input = "hello world";
	vals[0].output = "b94d27b9934d3e08a52e52d7da7dabfac484efe37a5380ee9088f7ace2efcde9";

	vals[0].input = "hello world asd awd awd awdapodawpokawpod ";
	vals[0].output = "99d71f95cafe05ea2dddebc35b6083bd5af0e44850c9dc5139b4476c99950be4";
...
cr_assert(not(eq(type(char),h1,tmp)));
...
cr_assert(not(eq(type(char),h2,tmp)));

SHA256 tmp_h2;

freshSumSHA256(c,&tmp_h2);

cr_assert(eq(type(char),h2,tmp_h2));
...
cr_assert(eq(type(char),sha1,h2));
...
cr_assert(not(eq(type(char),tmp,h)));
...
Test(hash,TestAddSHA256){
	...
	cr_assert(not(eq(type(char),add,tmp)));
	cr_assert(not(eq(type(char),add,h)));
	cr_assert(not(eq(type(char),add,i)));
}
...
Test(hash,TestXorSHA256){
	...
	cr_assert(not(eq(type(char),tmp_xor1,h)));
	cr_assert(not(eq(type(char),tmp_xor1,i)));
	cr_assert(not(eq(type(char),tmp_xor1,tmp)));
	cr_assert(eq(type(char),tmp_xor1,tmp_xor2));
