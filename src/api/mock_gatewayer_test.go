...
func (_m *MockGatewayer) GetBlockByHashVerbose(hash cipher.SHA256) (*readable.BlockVerbose, error) {
	ret := _m.Called(hash)

	var r0 *readable.BlockVerbose
	if rf, ok := ret.Get(0).(func(cipher.SHA256) *readable.BlockVerbose); ok {
		r0 = rf(hash)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*readable.BlockVerbose)
		}
	}
...
func (_m *MockGatewayer) GetBlockBySeqVerbose(seq uint64) (*readable.BlockVerbose, error) {
	ret := _m.Called(seq)

	var r0 *readable.BlockVerbose
	if rf, ok := ret.Get(0).(func(uint64) *readable.BlockVerbose); ok {
		r0 = rf(seq)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*readable.BlockVerbose)
...
func (_m *MockGatewayer) GetBlocksVerbose(start uint64, end uint64) (*readable.BlocksVerbose, error) {
	...
	if rf, ok := ret.Get(0).(func(uint64, uint64) *readable.BlocksVerbose); ok {
		r0 = rf(start, end)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*readable.BlocksVerbose)
		}
	}
...
func (_m *MockGatewayer) GetLastBlocksVerbose(num uint64) (*readable.BlocksVerbose, error) {
	ret := _m.Called(num)

	var r0 *readable.BlocksVerbose
	if rf, ok := ret.Get(0).(func(uint64) *readable.BlocksVerbose); ok {
		r0 = rf(num)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*readable.BlocksVerbose)
...
func (_m *MockGatewayer) GetVerboseTransactionsForAddress(a cipher.Address) ([]readable.TransactionVerbose, error) {
	ret := _m.Called(a)

	var r0 []readable.TransactionVerbose
	if rf, ok := ret.Get(0).(func(cipher.Address) []readable.TransactionVerbose); ok {
		r0 = rf(a)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]readable.TransactionVerbose)
		}
	}
