...
func setDefaults() {
	...
	viper.SetDefault("node.port", 6006)
	viper.SetDefault("node.web_interface_port", 6660)
	viper.SetDefault("node.unconfirmed_burn_factor", 5)
	viper.SetDefault("node.unconfirmed_max_transaction_size", 32*1024)
	viper.SetDefault("node.unconfirmed_max_decimals", 6)
	viper.SetDefault("node.create_block_burn_factor", 5)
	viper.SetDefault("node.create_block_max_transaction_size", 32*1024)
	viper.SetDefault("node.create_block_max_decimals", 6)
	...
	viper.SetDefault("node.coin_hours_ticker", "NCH")
	viper.SetDefault("node.qr_uri_prefix", "privateness")
	viper.SetDefault("node.explorer_url", "https://explorer.privateness.network")
	viper.SetDefault("node.version_url", "https://nodes.privateness.network/blockchain/version.txt")
	...
	viper.SetDefault("params.initial_unlocked_count", 100)
	viper.SetDefault("params.unlock_address_rate", 0)
	viper.SetDefault("params.unlock_time_interval", 60*60*24*365)
	viper.SetDefault("params.user_max_decimals", 6)
	viper.SetDefault("params.user_burn_factor", 5)
