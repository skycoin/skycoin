...
// 	GoSlice sig = {bufferSig1, 0, BUFFER_SIZE};
// 	GoSlice msg = {buff, 0, 32};
// 	char SecUxArrayBuffer[BUFFER_SIZE];
// 	char PubUxArrayBuffer[BUFFER_SIZE];
// 	coin__UxArray SecUxArray = {SecUxArrayBuffer, 0, BUFFER_SIZE};
// 	coin__UxArray PubUxArray = {PubUxArrayBuffer, 0, BUFFER_SIZE};

// 	error_code = SKY_secp256k1_GenerateKeyPair(&SecUxArray, &PubUxArray);
// 	cr_assert(error_code == SKY_OK, "SKY_secp256k1_GenerateKeyPair failed");
// 	error_code = SKY_secp256k1_RandByte(32, (coin__UxArray *)&msg);
// 	cr_assert(error_code == SKY_OK, "SKY_secp256k1_RandByte failed");
// 	copySlice(&SecUxArray, (GoSlice_ *)&sec1, sizeof(coin__UxArray));
// 	error_code == SKY_secp256k1_Sign(msg, sec1, (GoSlice_ *)&sig);
// 	cr_assert(error_code == SKY_OK, "SKY_secp256k1_Sign failed");
// 	cr_assert(sig.len == 65, "Signature should be 65 bytes long.");
...
// 		((unsigned char *)sig.data)[64] = ((unsigned char *)sig.data)[64] % 4;
// 		char bufferpub3[1024];
// 		GoSlice pub3 = {bufferpub3, 0, 1024};
// 		error_code = SKY_secp256k1_RecoverPubkey(msg, sig, &pub3);
// 		cr_assert(error_code == SKY_OK, "SKY_secp256k1_RecoverPubkey failed");
// 		cr_assert(cr_user_GoSlice_noteq(&pub1, &pub3), "Public keys must be different.");
// 		GoSlice pub2convert = {pub3.data, pub3.len, pub3.cap};
// 		error_code = SKY_secp256k1_VerifySignature(msg, sig, pub2convert, &result);
// 		cr_assert(error_code == SKY_OK, "SKY_secp256k1_VerifySignature failed");
// 		cr_assert(pub3.len == 0 || result, "Public key is not valid");
// 		error_code = SKY_secp256k1_VerifySignature(msg, sig, pub1, &result);
// 		cr_assert(error_code == SKY_OK, "SKY_secp256k1_VerifySignature");
