...
func TestVerifyTransactionSoftHardConstraints(t *testing.T) {
	...
	err = verifySingleTxnSoftHardConstraints(txn, params.DefaultMaxBlockSize, params.CoinHourBurnFactor)
	require.NoError(t, err)
	...
	err = verifySingleTxnSoftHardConstraints(tx2, params.DefaultMaxBlockSize, params.CoinHourBurnFactor)
	...
	err = verifySingleTxnSoftHardConstraints(lostCoinTx, params.DefaultMaxBlockSize, params.CoinHourBurnFactor)
	...
	err = verifySingleTxnSoftHardConstraints(dupUxOutTx, params.DefaultMaxBlockSize, params.CoinHourBurnFactor)
...
func TestVerifyTxnFeeCoinHoursAdditionFails(t *testing.T) {
	...
	err = VerifySingleTxnSoftConstraints(txn, head.Time()+1e6, uxIn, params.DefaultMaxBlockSize, params.CoinHourBurnFactor)
...
func testVerifyTransactionAddressLocking(t *testing.T, toAddr string, expectedErr error) {
	...
	err = VerifySingleTxnSoftConstraints(txn, head.Time(), uxIn, params.DefaultMaxBlockSize, params.CoinHourBurnFactor)
	if expectedErr == nil {
		require.NoError(t, err)
	} else {
