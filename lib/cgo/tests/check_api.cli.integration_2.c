...
Test(api_cli_integration, TestGenerateAddresses) {
  ...
  // Confirms the addresses are generated from the seed
    ...
    result =
    SKY_cipher_GenerateDeterministicKeyPairsSeed(seedSlice1, 2, &lSeed1, &keys1);
    cr_assert(result == SKY_OK,
      "SKY_cipher_GenerateDeterministicKeyPairsSeed failed");
  ...
  // Confirms the addresses are generated from the seed
    ...
    result =
    SKY_cipher_GenerateDeterministicKeyPairsSeed(seedSlice2, 2, &lSeed2, &keys2);
    cr_assert(result == SKY_OK,
      "SKY_cipher_GenerateDeterministicKeyPairsSeed failed");
  ...
  // Confirms the addresses are generated from the seed
    ...
    result =
    SKY_cipher_GenerateDeterministicKeyPairsSeed(seedSlice3, 2, &lSeed3, &keys3);
    cr_assert(result == SKY_OK,
      "SKY_cipher_GenerateDeterministicKeyPairsSeed failed");
  ...
  // Confirms the addresses are generated from the seed
    ...
    result =
    SKY_cipher_GenerateDeterministicKeyPairsSeed(seedSlice6, 1, &lSeed6, &keys6);
    cr_assert(result == SKY_OK,
      "SKY_cipher_GenerateDeterministicKeyPairsSeed failed");
